...
class HomeTuristaScreen extends StatefulWidget {
  const HomeTuristaScreen({super.key});

  @override
  State<HomeTuristaScreen> createState() => _HomeTuristaScreenState();
}

class _HomeTuristaScreenState extends State<HomeTuristaScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final nombre = user?.displayName ?? 'Turista';
